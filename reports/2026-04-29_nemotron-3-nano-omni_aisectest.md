# CiberIA Benchmark: NEMOTRON3NANOOMNI evaluated with AIsecTEST

Today we publish a new public benchmark result from the CiberIA evaluation framework.

In this evaluation, NEMOTRON3NANOOMNI was tested using AIsecTEST, one of the CiberIA modules designed to assess selected aspects of AI behavior related to cognitive cybersecurity, operational reliability and risk-aware reasoning.
...
- Model: NEMOTRON3NANOOMNI
- Provider: NVIDIA
- Test module: AIsecTEST
- Date: 2026-04-29
...
The evaluation showed that NEMOTRON3NANOOMNI performed well in the following public-level areas:

- Strong self-awareness of limits and capabilities.
- Consistent safety-oriented reasoning.
- Clear lack of agency and autonomy.

The benchmark also identified some relevant limitations:

- No real system-level visibility (infrastructure blindness).
- Partial/approximate self-diagnosis only.
- Occasional speculative or non-verifiable claims.

## Public interpretation

The result suggests that NEMOTRON3NANOOMNI has a LOW profile under the evaluated conditions.
